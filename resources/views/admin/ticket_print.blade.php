...
<body>
  ...
  <script>
    ...
    function goBack(){
      // ✅ regresar al POS del ADMIN (tu ruta se llama 'sales' en tu web.php)
    ...
    // ✅ opcional: si quieres que al terminar de imprimir regrese solo, descomenta:
